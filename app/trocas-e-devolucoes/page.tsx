    ...
    <>
      ...
      <main className="min-h-screen bg-surface-page">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h1 className="font-display text-3xl text-navy mb-2">Trocas e Devoluções</h1>
          ...
          <div className="prose max-w-none space-y-8 text-ink-secondary leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">1. Direito de arrependimento (7 dias)</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">2. Produto com defeito ou divergente</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">3. Como solicitar</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">4. Reembolso</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">5. O que não é aceito para devolução</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">6. Contato</h2>
              <p>
