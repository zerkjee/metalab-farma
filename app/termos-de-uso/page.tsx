    ...
    <>
      ...
      <main className="min-h-screen bg-surface-page">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h1 className="font-display text-3xl text-navy mb-2">Termos de Uso</h1>
          ...
          <div className="prose max-w-none space-y-8 text-ink-secondary leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">1. Aceitação</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">2. Cadastro e conta</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">3. Produtos e preços</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">4. Compras e pagamento</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">5. Entrega</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">6. Uso proibido</h2>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">7. Propriedade intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">8. Aviso sobre suplementos</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">9. Limitação de responsabilidade</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">10. Alterações nos termos</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">11. Lei aplicável e foro</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl text-navy mb-3">12. Contato</h2>
              <p>
