...
export const mockAdminOrders: AdminOrderDetail[] = customers.map(([name, email, city, state], index) => {
  ...
  return {
    ...
    items,
    ...amounts,
    payment: index % 3 === 0 ? 'Pix' : index % 3 === 1 ? 'Cartao de credito' : 'Boleto',
    ...
    notes: index % 2 === 0 ? 'Cliente solicitou envio discreto e nota fiscal no pacote.' : 'Sem observacoes internas.',
